...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-slate-900">
      ...
      >
        ...
        <div className="relative z-20 flex w-full flex-col items-center gap-4 px-6 pt-32 text-center text-white md:pt-48">
          ...
          <p className="max-w-2xl text-base text-white/80 sm:text-lg">
            Fundada el 29 de Enero de 1888.</p>
      ...
      <section className="mx-auto mb-20 mt-10 w-full px-4 sm:px-6">
        <div className="mx-auto max-w-7xl">
          <div
            className="relative mx-auto flex min-h-[650px] w-full flex-col items-center justify-center overflow-hidden rounded-3xl bg-black shadow-2xl"
            style={{
              backgroundImage: `linear-gradient(to top, rgba(2, 6, 23, 0.95), rgba(2, 6, 23, 0.75), rgba(15, 23, 42, 0.4)), url(${cancha})`,
              backgroundSize: 'cover',
              backgroundPosition: 'center'
            }}
          >
            <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/80 to-slate-900/40" />
            <div className="relative z-10 flex w-full flex-col items-center justify-center gap-5 px-6 py-10 text-center text-white sm:px-12">
              <p className="text-xs font-semibold uppercase tracking-[0.5em] text-red-400">Espacio Comunitario y Deportivo</p>
              <h3 className="max-w-3xl text-4xl font-semibold leading-tight sm:text-5xl lg:text-6xl">
                Cancha Techada de Alto Estándar
              </h3>
              <p className="max-w-4xl text-base text-slate-200 sm:text-lg">
